...
def train_opts(parser):
    ...
    group.add_argument('-train_src_mono', default='data/eng_mono.txt',
                       help="Path to the training source monolingual data")
    group.add_argument('-train_tgt_mono', default='data/ben_mono.txt',
    ...
    group.add_argument('-n_unsupervised_batches', type=int, default=48,
    ...
    group.add_argument('-enable_unsupervised_backtranslation', type=bool, default=True,
    ...
    group.add_argument('-tgt_to_src_dict', type=str, default='data/bn-en.txt',
                       help='Pretrained word embeddings for tgt language.')
    group.add_argument('-bootstrapped_model', type=str, default='bootstrap_model.pt', #Changed from 0
    ...
    group.add_argument('-src_vocab_size', type=int, default=75000,
                       help="Size of the source vocabulary")
    group.add_argument('-tgt_vocab_size', type=int, default=75000,
                       help="Size of the target vocabulary")

    # Model loading/saving options
    group = parser.add_argument_group('General')
    group.add_argument('-save_model', default='bootstrap_model2', #CHANGED FROM 'model' to 'bootstrap_model'
    ...
    group.add_argument('-sv_num_words_in_batch', type=int, default=128,
                       help='Batch size in words for supervised training')
    group.add_argument('-usv_num_words_in_batch', type=int, default=64,
                       help='Batch size in words for unsupervised training')
    group.add_argument('-unsupervised_epochs', type=int, default=50,
                       help='Number of unsupervised training epochs')
    group.add_argument('-supervised_epochs', type=int, default=50,

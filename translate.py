...
def translate_opts(parser):
    ...
    group.add_argument('-model', type=str, default='bootstrap_model2.pt',help='Path to model .pt file')
    group.add_argument('-s', default='data/eng_test.txt', help='source_file')

...
src_vector="dataset/vector/wiki.en.align.vec"
tgt_vector="dataset/vector/wiki.bn.align.vec"

en_dictionary = FastVector(vector_file=src_vector)
bn_dictionary = FastVector(vector_file=tgt_vector)